...
# Garante que 'app' seja importável quando o alembic roda a partir da pasta backend/
...
import app.models.comanda  # noqa: F401,E402
...
import app.models.evolution  # noqa: F401,E402
import app.models.legal_acceptance  # noqa: F401,E402
import app.models.marketing_permission  # noqa: F401,E402

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# Usa a mesma URL de banco configurada no .env do projeto,
# em vez da URL fixa do alembic.ini.
