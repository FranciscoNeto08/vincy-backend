...
def _to_response_dict(appt: Appointment) -> dict:
    return {
        ...
        "service_description": appt.service.description if appt.service else None,
        "service_duration": appt.service.duration if appt.service else None,
        "service_price": appt.service.price if appt.service else None,
